...
using Bcity_Practical.Models;
using Bcity_Practical.Services;
...
namespace Bcity_Practical.Controllers
{
    public class ClientController : Controller
    {
        ...
        {
            //Console.WriteLine("POST METHOD HIT"); used this output to test
            ...
            //Console.WriteLine("ModelState VALID"); used this out to test
